          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-3">
              ...
              <Link
                ...
                className="hidden md:flex items-center gap-2 rounded-xl bg-[#C6A15B] px-4 py-2 text-sm font-bold text-[#08111f] transition duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#C6A15B]/20"
              >
